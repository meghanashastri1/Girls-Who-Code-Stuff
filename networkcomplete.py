                                            #username = input("Enter your username")
                                              ...
                                              #Account = User(username, name, birthday, age)


                                              #Meghana = User("meghana360", "Meghana Shastri", "6/27/00", "17")
                                                #print(Meghana.getName())
                                                #print(Meghana.getUsername())
                                                #print(Meghana.getBirthday())
                                                #print(Meghana.getAge())
                                                ...
                                                #username = input("Enter your username   ")
                                                  ...
                                                  #print(birthday)
                                                  #print(age)
                                                  #print("Welcome to your new social network account!")
